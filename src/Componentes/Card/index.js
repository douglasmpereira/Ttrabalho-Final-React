                ...
                <div className="card-header d-flex align-items-center">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-end">
                            <button className="btn btn-sm btn-outline-primary" onClick={() => editarProduto(produto)}>
                                <div className='d-flex align-items-center'>Editar</div>    
                            </button>
                            <button className="btn btn-sm btn-outline-danger ms-1" onClick={() => excluirProduto(produto.id)}>
